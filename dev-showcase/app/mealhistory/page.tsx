...
import MealTable from '@/src/showcase/components/MealTable'
    ...
    <div className="pt-16 overflow-x-hidden">
      ...
      <div className="sticky top-16 z-40 bg-background/95 backdrop-blur-xl border-b border-border px-3 md:px-6 py-2.5 md:py-3">
        <div className="flex items-center justify-between gap-3 max-w-5xl mx-auto">
          <h2 className="text-base md:text-lg font-bold shrink-0">🥗 Meal History</h2>
