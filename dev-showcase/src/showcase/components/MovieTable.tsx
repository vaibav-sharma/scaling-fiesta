    ...
    return (
      <div className="p-2 space-y-2 text-sm break-words whitespace-normal leading-relaxed">
        <div>
          ...
          <p className="text-primary font-medium break-words">{top.title || '-'}</p>
          {top.description && (
            <p className="text-muted-foreground mt-1 break-words">{top.description}</p>
          )}
        </div>
                      ...
                      <React.Fragment key={String(row.id)}>
                        <TableRow className="align-top">
                          ...
                          <TableCell className="break-words max-w-[200px]">
                            {top.title ? (
                              <>
                                <span className="text-sm font-medium block">{top.title}</span>
                                <span className="text-xs text-muted-foreground block break-words">
                                  {top.reason?.slice(0, 120) +
                                    (top.reason?.length > 120 ? '…' : '')}
                                </span>
                              </>
                            ) : (
